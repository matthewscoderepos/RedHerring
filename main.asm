...
.data
 ...
 EncodeMenu: .asciiz "\nChoose an Encoding Method:\n1).simple LSB\n2).monochrome LSB\n3).simple keyed monochrome LSB\n4).keyed monochrome LSB\n5).keyed chromatic LSB\n0). abort\n\n>"
